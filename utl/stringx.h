    ...
    http-client-c is free software you can redistribute it andor modify
    ...
    along with http-client-c. If not, see httpwww.gnu.orglicenses.
	...
	httpwww.ietf.orgrfcrfc2616.txt
